...
getInfo() {return `${username} has ${playTime} active hours!`;},
changeUsername(newName){ return `${newName} has ${playTime} active hours!`;},
updatePlayTime(hours){ return `${username} has ${playTime + hours} active hours!`;},
};
